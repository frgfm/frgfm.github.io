...
draft: false
aliases:
  - /tech-brewing/choosing-a-new-laptop
twitter-card:
  title: How to choose your new laptop
  image: https://images.unsplash.com/photo-1593642531955-b62e17bdaa9c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=869&q=80
  image-alt: A picture of a laptop on a table
  card-style: "summary_large_image"
  description: Let's explore together how accessible it is for anyone to efficiently select the best laptop for their needs.
open-graph:
  image: https://images.unsplash.com/photo-1593642531955-b62e17bdaa9c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=869&q=80
  description: Let's explore together how accessible it is for anyone to efficiently select the best laptop for their needs.
  published-time: 2022-05-29
---
...
![](https://media2.giphy.com/media/aNqEFrYVnsS52/giphy.gif?cid=790b76110bc8301ab8d1364278f76e6744830cc3678964af&rid=giphy.gif&ct=g){fig-align="center" fig-alt="A cat typing on a keyboard."}
...
![](https://microage.ca/quebec/wp-content/uploads/sites/56/bb-plugin/cache/hard-drive-ssd-1-landscape.jpg){fig-align="center" fig-alt="Components comparison of HDD and SSD."}
...
![](https://www.enterprisestorageforum.com/wp-content/uploads/2021/02/fragmentation-understanding-disk-and-ram-fragmentation_6019c77851081.png){fig-align="center" fig-alt="Illustration of fragmentation on HDD."}

If you have a HDD and data reading is starting to get slower, you might be experiencing fragmentation. Files that have been repeatedly read or moved, might physically be in a suboptimal order on your physical disk. Since the rotation speed of the disk is limited, fragmentation increases the time needed to access a given file.<br>
...
![](https://www.crucial.fr/content/dam/crucial/dram-products/laptop/images/web/crucial-ddr4-sodimm-kit-w-shadow-image.psd.transform/small-jpg/img.jpg){fig-align="center" fig-alt="RAM sticks."}
...
![](https://www.cgdirector.com/wp-content/uploads/media/2021/05/CPU-vs-GPU-rendering.jpg){fig-align="center" fig-alt="Comparison of CPU & GPU."}
...
![](https://media3.giphy.com/media/4LwKrBfFQgBaw/giphy.gif?cid=790b76114abee4be7adcad307d3b666aaa2a4c05a8c7bb8f&rid=giphy.gif&ct=g){fig-align="center" fig-alt="GIF of unimpressed persons."}
...
::: {.callout-caution collapse="true"}
## Apple and its specific hardware
...
{{< tweet 80Level 1538816428253409280 >}}
...
#### Native resolution
![](images/screen-resolution.png){fig-align="center" fig-alt="The different screen resolution configurations."}
...
![](https://media4.giphy.com/media/urJSN8TN5o5A4/giphy.gif?cid=790b7611d93d6cfb9206bbee5fe2c903d26528e5c06dc304&rid=giphy.gif&ct=g){fig-align="center" fig-alt="A fan in awe at America Got Talent."}
...
![](https://media4.giphy.com/media/26FPqAHtgCBzKG9mo/giphy.gif?cid=790b76118828610e5a6665ccea6b6370e5a9af76a2051141&rid=giphy.gif&ct=g){fig-align="center" fig-alt="B99 characters doing noice."}
...
![](https://i.ytimg.com/vi/F4HkXEzzcRw/maxresdefault.jpg){fig-align="center" fig-alt="RTX."}
...
- <a href="https://www.youtube.com/watch?v=xPTjQ59gbJo">Ray tracing</a>: the rendering is done by tracing the path of light and its interaction, instead of performing rasterization (converting 3D graphics into 2D pixels thanks to shaders).
- <a href="https://www.nvidia.com/fr-fr/geforce/technologies/dlss/">DLSS</a> / <a href="https://www.amd.com/en/technologies/fidelityfx-super-resolution">FSR</a>: the GPU will oversample the rendering (spatially and temporarily) using Deep Learning to boost the FPS.
...
![](https://media4.giphy.com/media/3o84sq21TxDH6PyYms/giphy.gif?cid=ecf05e47cf6fbhh0178nxfjvjf2ha228rn3xrf4eb08ljyia&rid=giphy.gif&ct=g){fig-align="center" fig-alt="Palpine unleashes his full power."}
...
- **Battery**: if your laptop doesn't last as half as long as it used to, consider replacing the battery.
...
![](https://i.kym-cdn.com/photos/images/newsfeed/000/531/557/a88.jpg){fig-align="center" fig-alt="Cobb saying we need to go deeper in the movie Inception."}
...
![](https://media4.giphy.com/media/mGK1g88HZRa2FlKGbz/giphy.gif?cid=790b76115969c173099367a0b4034bcaa04fca45c56fe147&rid=giphy.gif&ct=g){fig-align="center" fig-alt="Chandler & Joey applauding."}
...
![](https://media1.giphy.com/media/NS7gPxeumewkWDOIxi/giphy.gif?cid=ecf05e47hz5b8gcpeps8u4rdjtnwld2403moye4oqaav9mg5&rid=giphy.gif&ct=g){fig-align="center" fig-alt="Detective Pikachu looking through a magnifying glass."}
...
{{< video https://www.youtube.com/embed/kRjyxh9AG1w >}}
...
{{< video https://www.youtube.com/embed/i9Dy_1SSw2U >}}
...
## Compare with your previous laptop
...
{{< video https://www.youtube.com/embed/Ej_mgN25a_I >}}
...
{{< video https://www.youtube.com/embed/m5to9qZwaDk >}}
...
{{< video https://www.youtube.com/embed/o-Z9JV4f4K0 >}}
:::

::: {.callout-note collapse="true"}
## Advanced note: MUX Switch

So this is a concept I discovered while benchmarking a few weeks back, quite an interesting one, especially if you're using your laptop for Gaming!

{{< video https://www.youtube.com/embed/6mWies_4oDs >}}

Laptops may or may not have a MUX switch, which a feature that can bypass the iGPU when data flows from the dGPU to your screen.<br> What does that mean?
...
![](https://media3.giphy.com/media/l0MYt5jPR6QX5pnqM/giphy.gif?cid=ecf05e472nuwpc7pvotkajg75odha0w3uek04s2gx4fz6si9&rid=giphy.gif&ct=g){fig-align="center" fig-alt="Characters of the Office dancing."}
...
![](https://media4.giphy.com/media/bVoflcc4kidaM/giphy.gif?cid=ecf05e47qlqb1hk1fupa01t51owbr4fijvq4zxornbq6l0vx&rid=giphy.gif&ct=g){fig-align="center" fig-alt="James McAvoy feeling too warm in the movei Wanted."}
...
![](https://media3.giphy.com/media/lD76yTC5zxZPG/giphy.gif?cid=ecf05e477c8s5rct86yltjz5cmmfdcl2icck93gxb8ufrk08&rid=giphy.gif&ct=g){fig-align="center" fig-alt="That's all folks!"}
